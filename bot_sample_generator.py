...
from data_indexer_selfdefine_bot import data_indexer
from compute_embedding import compute_embedding
from k_means import K_Means


class Bot_Sample_Generator(object):
    ...
    def generate_random_sample(self, values, inputs, rate):
        ...
        while len(positive_sample) + len(negative_sample) <= number * 2:
            ...
            pair_set = set(pair)
            if inputs[pair[0]].intent_id == inputs[pair[1]].intent_id:
...
bot_sample_generator = Bot_Sample_Generator()
